...
import org.vanilladb.core.storage.log.LogIterator;
 ...
 * {@link org.vanilladb.calvin.recovery.CalvinRecoveryMgr recovery manager}.
 */
public class CalvinLogMgr implements Iterable<BasicLogRecord> {
	/**
	...
	static {
		DEFAULT_LOG_FILE = CoreProperties.getLoader().getPropertyAsString(CalvinLogMgr.class.getName() + ".LOG_FILE",
				"Calvin.log");
	}
	...
	public CalvinLogMgr(String logFileName) {
		logFile = logFileName;
